...
/**
 * New API & TypeScript Version
 * Copyright 2022, Indra Gunawan <indra.sync@gmail.com>
 */

 import { document, Element } from './document.ts'
...
export default function htm(h: unknown) {
  return function (statics: TemplateStringsArray, ..._: unknown[]) {
    const result = evaluate(h as H, build(statics) as number[], arguments as unknown as unknown[], [])
